...
| `--reasoning-language en-US\|zh-CN` | steer new-turn reasoning to English or Simplified Chinese; `zh-CN` also selects Chinese as the default answer language; cannot be combined with `--no-thinking` | unset |
