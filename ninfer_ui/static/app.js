...
const I18N = {
  "zh-CN": {
    ...
    "settings.chineseReasoningHelp": "开启后引导使用中文思考，关闭后引导使用英文思考；长对话中仍可能切换语言。",
  ...
  en: {
    ...
    "settings.chineseReasoningHelp": "On guides reasoning in Chinese; off guides it in English. The language may still switch in long conversations.",
