...
const I18N = {
  "zh-CN": {
    ...
    "settings.chineseReasoningHelp": "开启后引导使用中文思考，长对话中仍可能切换语言。",
  ...
  en: {
    ...
    "settings.chineseReasoningHelp": "When enabled, guides reasoning in Chinese. The language may still switch in long conversations.",
